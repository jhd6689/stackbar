...
paint_button(AppClient *client, cairo_t *cr, Container *container) {
    ...
    if (data && data->surface) {
        ...
        // dye_surface(data->surface, config->color_apps_icons);  // disabled to keep icon colors
...
paint_grid_item(AppClient *client, cairo_t *cr, Container *container) {
    ...
    if (data->surface) {
        if (container->interactable) {
            // dye_surface(data->surface, config->color_apps_text);  // disabled to keep icon colors
        } else {
            // dye_surface(data->surface, config->color_apps_text_inactive);  // disabled to keep icon colors
        }
