...
paint_battery_bar(AppClient *client_entity, cairo_t *cr, Container *container) {
    ...
    // dye_surface(surface, config->color_battery_icons);  // disabled to keep icon colors
...
paint_brightness_icon(AppClient *client_entity, cairo_t *cr, Container *container) {
    ...
    // dye_surface(data->surface, config->color_battery_icons);  // disabled to keep icon colors
