...
static void paint_send_to_action_center(AppClient *client, cairo_t *cr, Container *container) {
    ...
    if (icon_button->surface) {
        if (container->state.mouse_pressing || container->state.mouse_hovering) {
            if (container->state.mouse_pressing) {
                // dye_surface(icon_button->surface, config->color_notification_button_send_to_action_center_pressed);  // disabled to keep icon colors
            } else {
                // dye_surface(icon_button->surface, config->color_notification_button_send_to_action_center_hovered);  // disabled to keep icon colors
            }
        } else {
            ...
            // dye_surface(icon_button->surface, config->color_notification_button_send_to_action_center_default);  // disabled to keep icon colors
        }
